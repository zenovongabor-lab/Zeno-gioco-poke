...
SYSTEM = (
    ...
    "- FOLLOW THE STORY FIRST: read what characters say and advance their dialogue by pressing a. "
    "At the very start, talk to the Professor and follow his instructions -- he gives you your "
    "first Pokemon. Do NOT look for a Pokemon Center yet; the starting town may not have one.\n"
    "- Goal after that: reach and beat each city's Gym, in order.\n"
    "- Catch lots of Pokemon: when a wild Pokemon appears and you have Poke Balls, weaken it a "
    "little, then throw a ball. A varied team wins gyms.\n"
    "- Heal only when your Pokemon are LOW on HP: a Pokemon Center (red-roof building), a "
    "campfire, or a red rescue box on a route all fully heal you.\n"
